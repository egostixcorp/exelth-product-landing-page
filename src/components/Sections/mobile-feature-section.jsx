...
// 8 items: alternating [wide, narrow] rows
const spanConfig = [
  "laptop:col-span-2",
  "laptop:col-span-1",
  "laptop:col-span-1",
...
function MobileCard({ feature, span }) {
  return (
    <div
    ...
    >
      {/* Phone screenshot — object-contain since portrait */}
  ...
  return (
    <section className="w-full px-[5%] py-16 laptop:px-[15%]">
      <div className="mx-auto mb-10 max-w-6xl text-center">
        <p className="text-sm font-medium text-green-600">Exelth Care App</p>
