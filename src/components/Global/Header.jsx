...
const Header = () => {
  return (
    <div className="fixed right-0 top-0 z-[999] flex h-16 w-full items-center justify-center">
      <div className="redd relative flex h-full w-full items-center justify-between bg-white p-1 px-[5%] laptop:px-[15%]">
        <div id="logo">
          <Link href={"/"}>
