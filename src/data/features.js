...
export const features = [
  {
    ...
    bnDesc:
      "তাৎক্ষণিক আপডেট এবং সহযোগিতার জন্য বিলিং, ফার্মেসি, নার্সিং এবং ডাক্তারদের মতো বিভাগগুলিকে নির্বিঘ্নে সংযুক্ত করুন। নিশ্চিত করুন যে সমস্ত স্টেকহোল্ডারদের রোগীর অবস্থা এবং কাজ সম্পর্কে রিয়েল টাইমে অবহিত করা হচ্ছে।",
  },
  // {
  //   title: "Automated Billing",
  //   icon: <Icon.FileCheck />,
  //   description:
  //     "Generate accurate bills by integrating data from hospital services such as diagnosis, treatment, and pharmacy. Automatically trigger insurance processing and notify stakeholders about discrepancies.",
  // },
  {
    ...
    bnDesc:
      "একটি সার্বজনীন কমান্ড প্যালেট ব্যবহার করে হাসপাতালের কর্মীদের দ্রুত রোগীর ক্রিয়াকলাপ, কর্মপ্রবাহ এবং সিস্টেম কমান্ড অ্যাক্সেস করতে সক্ষম করুন। কীবোর্ড-প্রথম নেভিগেশন এবং বুদ্ধিমান দ্রুত পদক্ষেপের মাধ্যমে দৈনন্দিন কাজগুলিকে গতিশীল করুন।",
  },
  {
    ...
    bnDesc:
      "প্রশাসনিক ও চিকিৎসাগত ছাড়পত্রের সাথে প্রস্তুতির সমন্বয় করে রোগীর ছুটি সহজ করুন। পরবর্তী ভর্তির জন্য কক্ষ প্রস্তুত করার জন্য কর্মীদের অবহিত করুন, বাধা কমিয়ে আনুন এবং বিছানা পরিবর্তন উন্নত করুন।",
  },
  {
    ...
    bnDesc:
      "রোগীদের চেকআউট পর্যবেক্ষণ, কাজগুলি ট্র্যাক এবং বিলম্বগুলি দক্ষতার সাথে সমাধান করার জন্য একটি কেন্দ্রীভূত ড্যাশবোর্ডের মাধ্যমে হাসপাতালের কর্মীদের ক্ষমতায়িত করুন। বিছানা দখলের সর্বোত্তম ব্যবহারের জন্য ছুটির সময় পূর্বাভাস দিন।",
  },
  {
    ...
    bnDesc:
      "রোগীদের তাদের চেকআউট অগ্রগতি ট্র্যাক করতে, বিল দেখতে, বীমা আপডেট পেতে এবং একটি ব্যবহারকারী-বান্ধব মোবাইল অ্যাপের মাধ্যমে অর্থ প্রদান করতে সক্ষম করুন। রিয়েল-টাইম আপডেট এবং স্বচ্ছতার সাথে রোগীর অভিজ্ঞতা সহজ করুন।",
  },
  // {
  //   title: "Workflow and Task Management",
  //   icon: <Icon.Workflow />,
  //   description:
  //     "Assign and monitor tasks across departments in real time. Ensure that bottlenecks are quickly identified and resolved, leading to a smoother hospital workflow.",
  // },
  {
    ...
    bnDesc:
      "হাসপাতালের কার্যক্রমে অদক্ষতা চিহ্নিত করতে, রোগীর প্রবণতা ট্র্যাক করতে এবং আর্থিক মেট্রিক্স পর্যবেক্ষণ করতে বিশ্লেষণ ব্যবহার করুন। সিদ্ধান্ত গ্রহণ এবং প্রক্রিয়া উন্নতির জন্য কার্যকর প্রতিবেদন তৈরি করুন।",
  },
  //   {
...
export const Mobilefeatures = [
  {
    ...
    bnDesc:
      "সহজেই অ্যাপয়েন্টমেন্ট বুক করুন, পুনঃনির্ধারণ করুন বা বাতিল করুন। বিলম্ব কমানোর জন্য রিয়েল-টাইম কিউ আপডেট এবং আনুমানিক অপেক্ষার সময়ের সাথে অবহিত থাকুন।",
  },
  {
    ...
    bnDesc:
      "একই জায়গায় আপনার সমস্ত স্বাস্থ্য যোগাযোগ অ্যাক্সেস করুন—অ্যাপয়েন্টমেন্ট, ল্যাব ফলাফল, প্রেসক্রিপশন এবং ফলো-আপ সহ সুইপ-টু-ম্যানেজ সমর্থন।",
  },
  {
    ...
    bnDesc:
      "সহজেই এক্সেলথ নেটওয়ার্কের মধ্যে হাসপাতাল, ক্লিনিক এবং বিশেষায়িত কেয়ার সেন্টারগুলি খুঁজে বের করুন। দিকনির্দেশনা, পরিষেবা এবং যোগাযোগের বিবরণ তাত্ক্ষণিকভাবে পান।",
  },
  {
    ...
    bnDesc:
      "আপনার সম্পূর্ণ যত্নের অভিজ্ঞতা পর্যবেক্ষণ করুন—অ্যাপয়েন্টমেন্ট এবং রুম বরাদ্দ থেকে ওষুধ, খাবার এবং চিকিৎসা রেকর্ড পর্যন্ত—সবই একটি টাইমলাইনে।",
  },
  {
    ...
    bnDesc:
      "যেকোনো সময় আপনার চিকিৎসা ইতিহাস এবং ল্যাব রিপোর্ট অ্যাক্সেস এবং পরিচালনা করুন। এন্ড-টু-এন্ড এনক্রিপশন এবং প্রাইভেসি-ফার্স্ট আর্কিটেকচারের সাথে সুরক্ষিত।",
  },
  {
    ...
    bnDesc:
      "একই মোবাইল অ্যাপে রোগী এবং ডাক্তার প্রোফাইলের মধ্যে নির্বিঘ্নে টগল করুন। আপনার ভূমিকার উপর ভিত্তি করে সঠিক বৈশিষ্ট্য, অ্যাপয়েন্টমেন্ট এবং সরঞ্জামগুলি অ্যাক্সেস করুন—নিরাপদ এবং সহজ।",
  },
  {
    ...
    bnDesc:
      "শক্তিশালী ফিল্টার সহ অনুসন্ধান ব্যবহার করে দ্রুত ডাক্তার, বিভাগ, হাসপাতাল বা পরিষেবা খুঁজুন। বিশেষত্ব, প্রাপ্যতা বা নিকটত্ব দ্বারা সাজান যা আপনাকে তাত্ক্ষণিকভাবে প্রয়োজন।",
  },

  {
    ...
    bnDesc:
      "প্রতিটি গুরুত্বপূর্ণ আপডেটের জন্য তাৎক্ষণিক সতর্কতা পান—অ্যাপয়েন্টমেন্ট রিমাইন্ডার থেকে নতুন প্রেসক্রিপশন এবং ল্যাব ফলাফল পর্যন্ত।",
  },
];
